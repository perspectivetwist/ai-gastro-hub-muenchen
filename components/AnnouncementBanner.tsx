...
export default function AnnouncementBanner() {
  ...
  if (pathname === "/muenchen-ki-studie-2026") return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>
          <span className="font-semibold">83% der Münchner Restaurants unsichtbar für KI.</span>{" "}
          Studie lesen
        </span>
        <span
